...
//	private static BnConfigurazione bnConfigurazione;
//
...
//			"DownloadJobEnd2End" };
//	
//	private static Logger logger = Logger.getLogger(LMSSample.class);
//
...
////				logger.error(" the configuration.xml roperties file is not found.");
////				System.exit(0);
////			}
...
////			bnConfigurazione = new BnConfigurazione(prop);
...
//		
//		init();
//		// Verifico se ci sono file da inviare
//		// VerificaFileToSend();
//		// Verifico se ci sono elaborazioni in corso da interrogare
//
//		boolean found = false;
//		if (args.length < 1) {
//			// if no parameters are given, then it print out the description of
//			// available commands
...
//
////	/**
////	 * La funzione verifica se nella cartella BnConfigurazione.pathFileToSend ci
////	 * sono file da inviare
////	 */
////	private static void VerificaFileToSend() {
////
////		File directory = new File(bnConfigurazione.getPathFileToSend());
////		// get all the files from a directory
////		File[] fList = directory.listFiles();
////		for (File file : fList) {
////			if (file.isFile()) {
////				logger.info("Elaborazione del file " + file.getName());
...
//			if (args.length < 3) {
//				System.out.println(
//						" UploadJobEnd2End Action Command Usage: UploadJobEnd2End <uploadFilePath> <downloadFilePath>");
//				return;
//			}
//			uploadFileName = args[1];
//			downloadFileName = args[2];
//			logger.info("\n***\n In LMSSample.main() ===> UploadJobEnd2End Job: uploadFileName=" + uploadFileName
...
//			} else {
//				logger.error("UploadJobEnd2End failed.");
//			}
//		}
//			break;
//		case 1: {// "UploadFile"
//			if (args.length < 3) {
//				System.out
//						.println(" UploadFile Action Command Usage : UploadFile <jobId> <fileRefId> <uploadFilePath>");
//				return;
//			}
//			jobId = args[1];
//			fileRefId = args[2];
...
//			if (args.length < 4) {
//				System.out.println(
//						" DownloadFile Action Command Usage : DownloadFile <jobId> <fileRefId> <downloadFilePath>");
//				return;
//			}
//			jobId = args[1];
//			fileRefId = args[2];
...
//			if (args.length < 3) {
//				System.out.println(
//						" end2EndDownloadJob Action Command Usage : end2EndDownloadJob <jobType> <downloadFilePath>");
//				return;
//			}
//			if (args.length == 3) {
//				jobType = args[1];
...
//		sb.append(
//				"8.Call FTS downloadFile service to download the result file that is specified by the 3rd input parameter\n");
//		sb.append("\n");
//		sb.append("\n");
//
...
//		sb.append(
//				"4.Call FTS downloadFile service to download the result file that is specified by the 2nd input parameter\n");
//		sb.append("\n");
//		sb.append("\n");
...
//		sb.append(
//				"2.Call FTS uploadFile service to upload file where JobID is the 2nd parameter and FileReferenceID is the 3rd parameter \n");
//		sb.append("\n");
//		sb.append("\n");
...
//		sb.append("2.JobID\n");
//		sb.append(
//				"This command calls BDX startUploadJob service to start the created upload job where JobID is the 2nd parameter.\n");
//		sb.append("\n");
//		sb.append("\n");
...
//		sb.append("2.JobID\n");
//		sb.append(
//				"This command calls BDX getJobStatus service to query the job status where JobID is the 2nd parameter.\n");
//		sb.append("\n");
//		sb.append("\n");
//
...
//		sb.append("2.JobID\n");
//		sb.append(
//				"This command calls BDX abortJob service to abort an unterminated job where JobID is the 2nd parameter.\n");
//		sb.append("\n");
//		sb.append("\n");
//
//		return sb.toString();
