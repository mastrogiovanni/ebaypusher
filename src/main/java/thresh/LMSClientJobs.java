...
//
//	public static boolean end2EndUploadJob(String uploadFileName, String downloadFileName, String JobStatusQueryInterval) throws Exception {
//		
...
//		// System.out.println(profile.getJobStatus() + ": " + profile.getJobId()
...
//	}
//
//	public static boolean end2EndDownloadJob(String downloadJobType, String downloadFileName,
//			String JobStatusQueryInterval) throws Exception {
//		logger.info("\n******\n DownloadJobEnd2End : downloadJobType=" + downloadJobType + " ; downloadFileName="
//				+ downloadFileName);
//		boolean done = false;
//		String jobid = "";
//
...
//		BulkDataExchangeActions bdeActions = new BulkDataExchangeActions(Configu);
//		FileTransferActions ftActions = new FileTransferActions();
...
//				logger.info("jobId=" + job.getJobId() + "; " + "jobFileReferenceId=" + job.getFileReferenceId() + " : "
//						+ job.getJobType() + " : " + job.getJobStatus());
//				fileProcessIsDone = true;
//				/*
//				 * DownloadFileResponse downloadFileResp =
//				 * ftActions.downloadFile(downloadFileName, jobId,
//				 * job.getFileReferenceId()); if (downloadFileResp != null) {
//				 * baseRep = downloadFileResp; if (isSuccess(baseRep)) {
//				 * downloadIsDone = true; } }
//				 *
//				 */
//				try {
...
//				logger.severe("JobId=" + job.getJobId() + ": " + "Job Type " + job.getJobType() + " : JobStatus= "
//						+ job.getJobStatus());
//				return false;
//			} else {
//				logger.info("JobId=" + job.getJobId() + ": " + "Job Type " + job.getJobType() + " : JobStatus= "
//						+ job.getJobStatus());
//				try {
...
//					logger.warning(error.getSeverity() + " --> ErrorID=" + error.getErrorId() + " ; ErrorMessage=\""
//							+ error.getMessage() + "\"");
//				} else if (response.getAck().equals(AckValue.FAILURE)
//						|| response.getAck().equals(AckValue.PARTIAL_FAILURE)) {
//					done = false;
//					logger.severe(error.getSeverity() + " --> ErrorID=" + error.getErrorId() + " ; ErrorMessage=\""
//							+ error.getMessage() + "\"");
//				}
//			}
//		}
...
//			if (job.getJobStatus().compareTo(JobStatus.ABORTED) == 0
//					|| job.getJobStatus().compareTo(JobStatus.ABORTED) == 0) {
...
//	}
//
//	private static StartDownloadJobResponse doStartDownloadJob(String downloadJobType, String startTimeString)
//			throws Exception {
//		BulkDataExchangeActions bdeActions = new BulkDataExchangeActions();
